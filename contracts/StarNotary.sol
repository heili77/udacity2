...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Udacity StarNotary TG";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerOf(_tokenId1) || msg.sender != ownerOf(_tokenId2), "No token owened by sender");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "owner is not sender");
